...
export const PACKAGE_RELEASES: readonly PackageRelease[] = [
  ...
  },
  {
    ...
    language: 'Rust',
    registry: 'crates-io',
    packageName: 'oresoftware-next-loggers-context',
    directory: 'sdk/rust-context',
    tagFormat: 'sdk/rust-context/v{version}',
    environment: 'crates-io',
    zedTarget: 'rust-context',
    manifestNative: true,
  },
  {
    target: 'rust-otel',
    language: 'Rust',
    registry: 'crates-io',
    packageName: 'oresoftware-next-loggers-otel',
    directory: 'sdk/rust-otel',
    tagFormat: 'sdk/rust-otel/v{version}',
    environment: 'crates-io',
    zedTarget: 'rust-otel',
    manifestNative: true,
  },
