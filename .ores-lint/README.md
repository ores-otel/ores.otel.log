...
installed, clippy not installed, no TypeScript parser available, crate deps not
fetchable — each is reported as a skip, not an error. Repo-specific ESLint
config that already existed is never overwritten.
